...
доступны команды захвата экрана, открытия настроек и выхода.
...
- Поддержать сборку и установку под Linux и macOS.
- Добавить значок в системный трей для доступа к запуску и настройкам.
- Реализовать диалог настроек с выбором языков OCR, горячих клавиш и путей.
- Сохранить историю скриншотов с возможностью повторного распознавания.
- При желании автоматически переводить распознанный текст при наличии интернет-соединения.
